...
echo ""
# Not hardcoded here - reads whatever ports are actually configured
# (respects .env overrides), and re-runnable any time with ./scripts/urls.sh
"$SCRIPT_DIR/urls.sh"
echo ""

print_info "Useful commands:"
echo "  Show these URLs again: ./scripts/urls.sh"
