...
// validating email addresses by regex is a well-known rabbit hole, and the
// current app doesn't need more than "looks like an email, no whitespace,
// exactly one @". express-validator's `isEmail()` (used today in
// authRoutes.js) is more permissive/complete; if real-world addresses ever
 ...
 * place, instead of the current pattern of calling express-validator's
